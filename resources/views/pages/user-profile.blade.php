            ...
            <div class="row">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="{{$user['user']['avatar_urls']['24']}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{ old('name', $user['user']['name']) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
