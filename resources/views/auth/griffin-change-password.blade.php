                                    ...
                                    <form role="form" method="POST" id="signupForm" action="{{route('griffin.postpassword')}}" autocomplete="off">
                                        ...
                                        <div class ="row">
                                            <div class="input-group mb-3">
                                                ...
                                                @error('email') <p class="text-danger text-xs pt-1" style="1px solid #d2d6da !important;"> {{$message}} </p>@enderror
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text"><i class="fa fa-lock"></i></span>
                                                <input type="password" name="password" id="password" class="form-control" required placeholder="Password" aria-label="Password" style="1px solid #d2d6da !important;">
                                            </div>
                                            ...
                                            <div class="input-group mb-3 mt-1">
                                                <span class="input-group-text"><i class="fa fa-lock"></i></span>
                                                <input type="password" required id="confirm-password" name="confirm-password" class="form-control form-control-lg" placeholder="Confirm-Password" aria-label="Password" style="1px solid #d2d6da !important;">
