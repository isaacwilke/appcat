                               ...
                               <img src="{{asset('argon/img/GRCR_logo_login.png')}}" class="text-center rounded mx-auto d-block img-fluid" alt="main_logo"/>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{route('login.griffin')}}" id="griifinloginform">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" id="btnlogin" class="btn btn-lg btn-blue btn-lg w-100 mt-4 mb-0">Sign in</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Forgot you password? 
                                        <a href="{{route('griffin.reset')}}" class="text-blue font-weight-bold">Reset your password</a>
                                    </p>
                                </div>
                                 {{--
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
