                                                    ...
                                                    <div class="row text-start">
                                                        ...
                                                        <div class="col-12 col-md-4  mt-3">
                                                         ...
                                                         <div class="col-12 col-md-4  mt-3">
                                                            ...
                                                            <input class="multisteps-form__input form-control" name="order_key" value="{{$order['order_key']}}" placeholder="Eg. 221" />
                                                        </div>
                                                        <div class="col-12 col-md-4 mt-3">
                                                            <label> discount_total</label>
                                                            <input class="multisteps-form__input form-control"  type="text" name="discount_total" value="{{$order['discount_total']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                        <div class="col-12 col-md-4 mt-3">
                                                            <label>discount_tax</label>
                                                            <input class="multisteps-form__input form-control"  type="text" name="discount_tax" value="{{$order['discount_tax']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-12 col-md-4 mt-3">
                                                            <label> shipping_total</label>
                                                            <input class="multisteps-form__input form-control"  type="text" name="shipping_total" value="{{$order['shipping_total']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-12 col-md-4 mt-3">
                                                            <label>shipping_tax</label>
                                                            <input class="multisteps-form__input form-control"  type="text" name="shipping_tax" value="{{$order['shipping_tax']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-12 col-md-4 mt-3">
                                                            <label> cart_tax</label>
                                                            <input class="multisteps-form__input form-control"   type="text" name="cart_tax" value="{{$order['cart_tax']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-12 col-md-4 mt-3">
                                                            <label> total</label>
                                                            <input class="multisteps-form__input form-control"  type="text" name="total" value="{{$order['total']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-6 col-md-6 mt-3">
                                                            <label> total_tax</label>
                                                            {{-- @php $billingemail = !empty($billing['billing']['email'])?$billing['billing']['email']:$billing['email'];@endphp --}}
                                                            <input class="multisteps-form__input form-control"   type="text" name="total_tax" value="{{$order['total_tax']}}"placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-6 col-md-6 mt-3">
                                                            <label> status</label>
                                                         ...
                                                         <div class="col-12 col-md-4 mt-3">
                                                            ...
                                                            <input class="multisteps-form__input form-control"   type="date" name="date_completed" value="{{$order['date_completed']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                         <div class="col-12 col-md-4 mt-3">
                                                            <label> date_paid</label>
                                                            <input class="multisteps-form__input form-control"  type="date" name="date_paid" value="{{$order['date_paid']}}" placeholder="Eg. Tokyo" />
                                                        </div>
                                                    </div>
